...
\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.55\textwidth]{SialidHabitus}
  \caption{Sialidae habitus. Photo (CC BY-SA 3.0) by Fritz Geller-Grimm \url{https://goo.gl/F6h0Oa}}
  \label{fig:sialid1}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[ht!]{0.45\textwidth}
      \centering
        \includegraphics[width=\textwidth]{sisyridWings.jpg}
        \caption{Wings \citep[][Fig. 328]{bhl29907}}
        \label{fig:sisyrid}
    \end{subfigure}
    \qquad
    \begin{subfigure}[ht!]{0.45\textwidth}
        \includegraphics[width=\textwidth]{sisyridHabitus}
